...
#vid_path = "/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/videos/video_sd.mp4"
...
labelsPath = "/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/coco.names"
LABELS = open(labelsPath).read().strip().split("\n")

np.random.seed(42)

weightsPath = "/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/yolov3.weights"
configPath = "/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/yolov3.cfg"
...
vs = cv2.VideoCapture("/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/videos/Social.mp4")
writer = None
(W, H) = (None, None)
...
while True:
    ...
    if len(idxs) > 0:
        ...
        for i in idf:
            ...
            cv2.putText(frame, "Social Distancing Analyser COVID-19", (210, 45),
                        cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 250, 205), 2)
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("/home/wasim/Downloads/Social-Distancing-Analyser-COVID-19-master/videos/output_2.mp4", fourcc, 30,
